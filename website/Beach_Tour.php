		...
		<div style="width:100%; float:left; position:relative;">
		 <span style="width:25%;float:left;">
				 <a href="#" style="text-decoration:none;" onMouseOver="ShowContent('contextBuild');" onMouseOut=" HideContent('contextBuild');"> 
				  <div class="tripHeaderbtn" id="div_BuildTrip" style="background:#002929; color:#FFFFFF;">Beach Tour
				</div> </a></span>
		 </div>
	...
	<div id="div_beachSelect" style="display:block;">
		<div align="left" style="width:100%;">
		 ...
		 <div align="center"  style="width:100%; margin-left:50px;">
		  <span class="div_others_chkTxt"><input id="chAct" type="checkbox" onChange="display_pics('chAct','content_Activities');" />
	 ...
	 <div style="overflow-y:scroll; height:400px; overflow-x:hidden; width:100%;">
		 <div id="content_Activities" style="overflow-x:hidden; overflow-y:hidden; height:auto; margin-top:2px; display:none; width:100%;">		 
		  ...
		  echo '<div style="width:100%; margin-top:25px;">
			<a href="Packages.php?type='.$_GET['type'].'&vactype=ADVENTURE TOUR&loc='.$_GET['loc'].'&dur='.$_GET['dur'].'&currLoc='.$_GET['currLoc'].'&mode='.$_GET['mode'].'&intensity='.$_GET['intensity'].'&agenda='.$_GET['agenda'].'&locType='.$_GET['locType'].'&locNum='.$_GET['locNum'].'&trvlr='.$_GET['trvlr'].'" target="_blank" style="text-decoration:none;">
