...
$wrt.='<div style="float:left; width:100%;">
   ...
   <table class="font-small" style="float:left; width:100%; color:#fff;" cellpadding="1" cellspacing="0" border="1px" bordercolor="#aaa">
  ...
  <tr height="30px"><th colspan="6"></th></tr>
	 ...
	 if($res_qt_itin)
	 {
	  ...
	  {
	    $wrt.= '<tr>';
		$wrt.= '<td align="left">'.$row["loc_name"].'</td>';
		$wrt.= '<td align="left">'.$row["cate_id"].'</td>';
		$wrt.= '<td align="left">'.$row["attr_name"].'</td>';
		$wrt.= '<td align="left">'.$row["trv_date"].'</td>';
		$wrt.= '<td align="left">'.$row["schedule"].'</td>';
		$wrt.= '<td align="left"></td>';
		$wrt.= '</tr>';
	  }
	  ...
	  {
	    $wrt.= '<tr style="border:1px solid #555;"><td colspan="6">'.$r["comment"].'</td></tr>';
	  }
	 }
